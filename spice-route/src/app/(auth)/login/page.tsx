    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to your Spice Route account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between">
              ...
              <Link href="/forgot-password" className="text-xs text-saffron-600 hover:underline">Forgot password?</Link>
            </div>
            <input
              type="password"
              value={password}
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link href="/register" className="text-saffron-600 font-medium hover:underline">Create one</Link>
        </p>
      </div>
    </div>
  )
